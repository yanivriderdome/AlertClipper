...
# Video_folder = r"I:\Videos\New_Rides\Box 12 Ariff"
Folder = "Box 14"
...
indices = get_file_indices('/media/rider/4689-5BB2/Front_Alerts/', '/media/rider/6575-F30A2/Blindspot_All/', Out_folder)
...
if n_files > 0 or not copy_files:
    ...
    if Run_Jetson_App:
        ...
        stdin, stdout, stderr = ssh.exec_command('cd ~/riderdome && ./rider_jetson -batch_front \"/home/rider/riderdome/Videos/*cam1*.mp4\"')
